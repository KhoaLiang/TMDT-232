                  ...
                  <div class="container bg-light rounded p-3 mt-3">
                        <div class="row justify-content-center align-items-center">
                              ...
                              <div class="col-12 col-md-7 mt-md-0 mt-3">
                                    ...
                                    <p>Publish date: <?php echo date('F j, Y', strtotime($bPublishDate)); ?></p>
                                    <div>
                                    ...
                                    <form class='mt-3' id='addToCartForm'>
                                          <div>
                                                ...
                                                <label class="btn border border-1 border-dark ms-3" for="ebook">E-book</label>
                                          </div>
                                          ...
                                          <div class='mt-3 d-flex align-items-center'>
                                                <div class="btn-group" role="group">
                                                      ...
                                                      <input onchange='checkAmmount()' type="number" class="fw-bold ammount_input ps-2 border border-2 border-secondary" id="book_ammount" autocomplete="off" value="1" min="1" max="">
                                                ...
                                                <p class='mb-0 ms-3'>In stock: <strong id='in_stock'>1</strong></p>
                                          </div>
